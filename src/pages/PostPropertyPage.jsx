...
import { Check, Phone, Bell, ChevronDown, Home, Plus, Minus } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center space-x-3">
              <button className="p-2 hover:bg-amber-500 rounded-full transition" aria-label="Notifications">
                <Bell className="w-5 h-5" />
              </button>
              <div className="flex items-center space-x-2 cursor-pointer hover:bg-amber-500 px-3 py-1.5 rounded transition">
                <div className="flex items-center justify-center w-8 h-8 bg-amber-400 rounded-full font-bold text-slate-900 text-sm">
                  RM
                </div>
                <ChevronDown className="w-4 h-4" />
              </div>
              <button className="p-2 hover:bg-amber-500 rounded transition" aria-label="Menu">
              ...
              <AnimatePresence mode="wait">
                ...
                {currentStep === 5 && (
                  ...
                  >
                    ...
                    <div className="mt-8 bg-amber-50 border border-purple-200 rounded-lg p-4 flex items-start">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={() => alert('Property posted successfully!')}
                      className="mt-8 bg-amber-500 text-white px-8 py-2.5 rounded font-semibold hover:bg-amber-600 transition-colors text-sm"
                    >
                      Post Property
                    </motion.button>
